...
; simulated remote quantum computers, or on local simulators, In thsi regard, 
...
;
; Notes:
; - You should have qre installed on your path.
...
(system "./qre examples/example6.qasm post y qlib_simulator 1 example6_1")
